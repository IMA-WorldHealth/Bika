// AddTabManagerCorrections.js

define("bika/TabManager/TabManager", 
  ["dijit/layout/TabContainer", "dijit/layout/ContentPane","dojo/_base/declare"], 
  function(TabContainer, ContentPane, declare){
    return declare("bika.TabManager.TabManager",TabContainer, {
      ...
      openTab: function( title, href, closable) {
        ...
        if(add == true){
          ...
          var pane = new ContentPane({
            ...
            onClose: function(){
                    valeurChoix = true;
                if(valeurChoix == true){ // comment: this can be done like if (valeurChoix) implicitely
