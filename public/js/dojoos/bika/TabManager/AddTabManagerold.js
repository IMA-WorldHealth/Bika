					...
					var pane = new ContentPane({
         				...
         				closable: closable,
							onClose: function(){
						        valeurChoix = true;
								/*
								var tabIndice = this.id;
	var start="_";
	var longueur = tabIndice.length;
	var indexSub = tabIndice.lastIndexOf(start,longueur);
	var idx = tabIndice.substring(indexSub + 1)
	*/
								//console.log(idx);
								//this.removeChild(tabPane[idx]);
								//this.destroyRecursive();
								//this.resize();
								//console.log(tbcon.getIndexOfChild(tabPane[idx]));
								console.log(tbcon.getChildren().length);
								console.log(tbcon.getChildren()[0].title);
								if(valeurChoix == true){
									    //console.log(tbcon.getChildren().length);
										//console.log(tbcon.getChildren()[0].title);
